import '../../../styles/detalle-curso-dashboard.scss';
...
export default function DetalleCursoId({data}) {
    ...
    return (
        <div className="pageCont pageDetCurso inlineBlock pageDetCursoDash">
            {dataCourse &&
                    ...
                    <div className="inlineFlex pdcDescription">
                                            ...
                                            return (                                       
                                                <div key={faker.string.uuid()} className="inlineBlock pdcdRecoItem">
                                                    ...
                                                    <div className="action">
                                                        <Link href={'/dashboard/cursos/'+item.slug} className="btnBorder">
                                                            Ver curso
                                                        </Link>
                                                    </div>
                                                </div >
                        ...
                        <div className="inlineFlex sideBar">
                            ...
                            <div className="sideThanks">
                                ...
                                <Link href={'/dashboard/mis-cursos/catalogo'}>
                            ...
                            <div className="inlineBlock sideLinkCat">
                                <Link href={'/dashboard/mis-cursos/catalogo'}>Volver a categorías</Link>
                            </div>
                        </div>
                    </div>
                </div>
...
export async function getServerSideProps({params}) {
    try {
        const res = await fetch('https://api.lessin.pe/wp-json/wp/v2/cursos?slug='+params.info);
