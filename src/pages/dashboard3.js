              ...
              <div className="inlineFlex uhIntro">
                ...
                <figure className="introImg">
                  <div className="det det1">
                    {dataUser.detalle ? 
                      <Image src={dataUser.detalle} width={50} height={50}/>
                    :  
                      <Image src={dashboard_ico1} width={50} height={50}/>
                    }
                  ...
                  <div className="det det3">
                    {dataUser.logo ? 
                      <Image src={dataUser.logo} width={50} height={50}/>
                    :  
                      <Image src={dashboard_ico2} width={50} height={50}/>
                    }
                      
                  </div>
                  {dataUser.cover ? 
                    <Image src={dataUser.cover} width={50} height={50}/>
                  :  
                    <Image src={introImg} width={50} height={50} />
                  }
                  ...
                  <SwiperSlide>
                    <div className="cursoItem">
                      <figure>
                        ...
                        <figcaption>
                          <div className="item">
                            <Image src={icoStart} /> 4.5
                          </div>
                          <div className="item">
                            <Image src={icoCursoStudent} /> 30 estudiantes
                          </div>
                        </figcaption>
                      </figure>
                      <div className="txt">
